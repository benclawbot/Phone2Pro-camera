...
public final class FullSpecificationActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView description = text(
                "Build one evidence-backed JSON specification of the public camera surface, hidden/system-only ID boundary, stream sessions, request/result metadata, vendor tags, sensor calibration, and burst performance.",
                15,
                Color.LTGRAY
        );
        ...
        TextView privacy = text(
                "All analysis stays on the phone. The full run drains test YUV frames without saving photographs and does not require network access.",
                13,
        ...
        legacyButton = new Button(this);
        legacyButton.setAllCaps(false);
        legacyButton.setText("Open focused capture audits");
        legacyButton.setOnClickListener(v -> startActivity(
                new Intent(this, MainActivity.class)
        ));
        root.addView(legacyButton, new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
        ));
